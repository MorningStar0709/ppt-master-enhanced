...
This repository is maintained by [MorningStar0709](https://github.com/MorningStar0709) as a deeply customized derivative of the original PPT Master project by Hugo He. This version focuses on a stricter review-driven workflow, stronger Windows/Trae execution constraints, and more conservative export gating.
