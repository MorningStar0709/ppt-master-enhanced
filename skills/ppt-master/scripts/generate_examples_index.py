...
Usage:
    conda run -n ppt-master python skills/ppt-master/scripts/generate_examples_index.py
    conda run -n ppt-master python skills/ppt-master/scripts/generate_examples_index.py examples
"""
...
def generate_examples_index(examples_dir: str = 'examples') -> str:
    ...
    content.append("```bash")
    content.append(
        "conda run --no-capture-output -n ppt-master python skills/ppt-master/scripts/project_manager.py init my_project --format ppt169 --dir examples")
    content.append("```\n")
    ...
    content.append(
        "2. Validate the project: `conda run --no-capture-output -n ppt-master python skills/ppt-master/scripts/project_manager.py validate examples/<project>`")
    content.append("3. Update the index: `conda run --no-capture-output -n ppt-master python skills/ppt-master/scripts/generate_examples_index.py`")
