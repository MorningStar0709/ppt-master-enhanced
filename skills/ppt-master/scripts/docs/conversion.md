...
```bash
conda run -n ppt-master python scripts/source_to_md/pdf_to_md.py book.pdf
conda run -n ppt-master python scripts/source_to_md/pdf_to_md.py book.pdf -o output.md
conda run -n ppt-master python scripts/source_to_md/pdf_to_md.py ./pdfs
conda run -n ppt-master python scripts/source_to_md/pdf_to_md.py ./pdfs -o ./markdown
```
...
```bash
conda run -n ppt-master pip install PyMuPDF
```
...
```bash
conda run -n ppt-master python scripts/source_to_md/doc_to_md.py lecture.docx
conda run -n ppt-master python scripts/source_to_md/doc_to_md.py lecture.docx -o output.md
conda run -n ppt-master python scripts/source_to_md/doc_to_md.py notes.epub
conda run -n ppt-master python scripts/source_to_md/doc_to_md.py paper.tex -o paper.md  # uses pandoc
```
...
conda run -n ppt-master pip install mammoth markdownify ebooklib nbconvert beautifulsoup4
...
```bash
conda run -n ppt-master python scripts/source_to_md/ppt_to_md.py sales_deck.pptx
conda run -n ppt-master python scripts/source_to_md/ppt_to_md.py sales_deck.pptx -o output.md
conda run -n ppt-master python scripts/source_to_md/ppt_to_md.py ./decks
conda run -n ppt-master python scripts/source_to_md/ppt_to_md.py ./decks -o ./markdown
conda run -n ppt-master python scripts/source_to_md/ppt_to_md.py template.ppsx -o notes/template.md
```
...
```bash
conda run -n ppt-master python scripts/source_to_md/web_to_md.py https://example.com/article
conda run -n ppt-master python scripts/source_to_md/web_to_md.py https://url1.com https://url2.com
conda run -n ppt-master python scripts/source_to_md/web_to_md.py -f urls.txt
conda run -n ppt-master python scripts/source_to_md/web_to_md.py https://example.com -o output.md
```
...
```bash
conda run -n ppt-master python scripts/rotate_images.py auto projects/xxx_files
conda run -n ppt-master python scripts/rotate_images.py gen projects/xxx_files
conda run -n ppt-master python scripts/rotate_images.py fix fixes.json
```
