...
Usage:
    conda run -n ppt-master python scripts/analyze_images.py <images_folder_path>
    conda run -n ppt-master python scripts/analyze_images.py projects/xxx/images
    conda run -n ppt-master python scripts/analyze_images.py projects/xxx/images --canvas ppt43
...
try:
    ...
    print("Error: PIL/Pillow not installed. Run: conda run -n ppt-master pip install Pillow")
    sys.exit(1)
