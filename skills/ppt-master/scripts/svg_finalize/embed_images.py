...
Usage:
    conda run -n ppt-master python scripts/svg_finalize/embed_images.py <svg_file> [svg_file2] ...
    conda run -n ppt-master python scripts/svg_finalize/embed_images.py *.svg

Examples:
    conda run -n ppt-master python scripts/svg_finalize/embed_images.py examples/ppt169_demo/svg_output/01_cover.svg
    conda run -n ppt-master python scripts/svg_finalize/embed_images.py examples/ppt169_demo/svg_output/*.svg
"""
