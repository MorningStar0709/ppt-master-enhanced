...
Usage:
    conda run -n ppt-master python scripts/svg_finalize/fix_image_aspect.py <svg_file> [svg_file2] ...
    conda run -n ppt-master python scripts/svg_finalize/fix_image_aspect.py projects/xxx/svg_output/*.svg

    # Preview mode
    conda run -n ppt-master python scripts/svg_finalize/fix_image_aspect.py --dry-run projects/xxx/svg_output/*.svg

Examples:
    conda run -n ppt-master python scripts/svg_finalize/fix_image_aspect.py projects/demo/svg_output/slide_06_current_overview.svg
"""
...
try:
    ...
    HAS_PIL = False
    print("[WARN] PIL not installed. Install with: conda run -n ppt-master pip install Pillow")
