...
Usage:
    conda run -n ppt-master python scripts/svg_finalize/svg_rect_to_path.py <SVG file or directory>
    conda run -n ppt-master python scripts/svg_finalize/svg_rect_to_path.py <project_path> -s output
    conda run -n ppt-master python scripts/svg_finalize/svg_rect_to_path.py <project_path> -s final -o svg_rounded

Examples:
    conda run -n ppt-master python scripts/svg_finalize/svg_rect_to_path.py examples/ppt169_demo
    conda run -n ppt-master python scripts/svg_finalize/svg_rect_to_path.py examples/ppt169_demo/svg_output/01_cover.svg
