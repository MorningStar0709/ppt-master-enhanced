...
1. **Apply template**: Prefer `project_manager.py apply-template <project_path> <template_name>` so SVG/design files land in `templates/` and image assets land in `images/`
