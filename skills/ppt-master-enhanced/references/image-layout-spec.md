...
```bash
conda run -n ppt-master python scripts/analyze_images.py <project_path>/images                    # Default: PPT 16:9
conda run -n ppt-master python scripts/analyze_images.py <project_path>/images --canvas ppt43     # PPT 4:3
conda run -n ppt-master python scripts/analyze_images.py <project_path>/images --canvas xiaohongshu  # Xiaohongshu
```
