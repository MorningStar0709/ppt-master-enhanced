...
> Common guidelines: `executor-base.md`. Technical constraints: `shared-standards.md`. SVG review rules and blocking pass/fail criteria come from `references/svg-review/`; this file only adds MBB-level review supplements.
...
## Style-specific Review Supplement (Consultant Top)
