...
The `review/` directory contains reusable templates for SVG review and export approval:

- page-by-page review log
- fix task tracking
- user confirmation before post-processing and export

- **Human browsing**: [review/review_index.md](./review/review_index.md)
...
- **Search icons**: `ls skills/ppt-master-enhanced/templates/icons/<library>/ | grep <keyword>`

## How Review References And Templates Work Together

- `references/svg-review/` defines the review rules, severity, and fix logic
- `templates/review/` provides the reusable record formats used during execution
