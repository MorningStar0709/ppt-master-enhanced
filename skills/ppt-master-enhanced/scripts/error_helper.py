    ...
    ERROR_SOLUTIONS = {
        'missing_readme': {
            ...
            'solutions': [
                ...
                'Copy the reference README into your project with native file tools or a platform-appropriate copy command'
            ],
            'severity': 'error'
        },
        'missing_spec': {
        ...
        'missing_svg_output': {
            ...
            'solutions': [
                'Initialize the project through project_manager.py init so the standard directories are created automatically',
        ...
        'clippath_detected': {
            'message': 'Invalid clip-path usage detected',
            'solutions': [
                'Use clip-path only on <image> elements',
                'Ensure the referenced <clipPath> is defined inside <defs>',
                'For shapes and groups, draw the target geometry directly instead of clipping',
