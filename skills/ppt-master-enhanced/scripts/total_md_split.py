...
Usage:
    ...
    conda run -n ppt-master python scripts/total_md_split.py <project_path> -o output_dir

Examples:
    conda run -n ppt-master python scripts/total_md_split.py projects/<svg_title>_ppt169
    conda run -n ppt-master python scripts/total_md_split.py projects/<svg_title>_ppt169 -o notes
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
            %(prog)s projects/<svg_title>_ppt169
            %(prog)s projects/<svg_title>_ppt169 -o notes
            %(prog)s projects/<svg_title>_ppt169 -q
...
'''
    ...
    if not review_status.export_allowed:
        print("Error: SVG Review Gate has not passed. Speaker notes splitting is blocked.")
