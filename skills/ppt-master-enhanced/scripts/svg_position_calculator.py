...
4. Quick calculation:
   ...
   conda run -n ppt-master python scripts/svg_position_calculator.py calc line --data "0:50,10:80,20:120"
   conda run -n ppt-master python scripts/svg_position_calculator.py calc grid --rows 2 --cols 3
...
Common commands:
  # Analyze SVG file
  conda run -n ppt-master python svg_position_calculator.py analyze example.svg

  # Interactive mode
  conda run -n ppt-master python svg_position_calculator.py interactive

  # Calculate from JSON config
  conda run -n ppt-master python svg_position_calculator.py from-json config.json

  # Quick calculation
  conda run -n ppt-master python svg_position_calculator.py calc bar --data "East:185,South:142"
  conda run -n ppt-master python svg_position_calculator.py calc pie --data "A:35,B:25,C:20"
  conda run -n ppt-master python svg_position_calculator.py calc line --data "0:50,10:80,20:120"
        """
    )
