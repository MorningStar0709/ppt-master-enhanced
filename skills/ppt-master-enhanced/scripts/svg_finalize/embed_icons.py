...
Icon libraries (subdirectories of templates/icons/):
    chunk/          - 640+ fill icons, 16x16 viewBox  (recommended default)
...
Usage:
    conda run -n ppt-master python scripts/svg_finalize/embed_icons.py <svg_file> [svg_file2] ...
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  conda run -n ppt-master python scripts/svg_finalize/embed_icons.py svg_output/01_cover.svg
  conda run -n ppt-master python scripts/svg_finalize/embed_icons.py svg_output/*.svg
  conda run -n ppt-master python scripts/svg_finalize/embed_icons.py --dry-run svg_output/*.svg
  conda run -n ppt-master python scripts/svg_finalize/embed_icons.py --icons-dir my_icons/ output.svg
        '''
    )
