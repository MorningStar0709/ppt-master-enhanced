...
Usage:
    conda run -n ppt-master python scripts/svg_finalize/crop_images.py <SVG file or directory> [--dry-run]
"""
...
try:
    ...
    print("Error: PIL (Pillow) is required. Run: conda run -n ppt-master pip install Pillow")
    exit(1)
