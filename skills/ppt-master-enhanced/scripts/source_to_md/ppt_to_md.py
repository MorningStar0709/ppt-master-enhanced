...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  conda run -n ppt-master python ppt_to_md.py slides.pptx
  conda run -n ppt-master python ppt_to_md.py slides.pptx -o output.md
  conda run -n ppt-master python ppt_to_md.py ./decks
  conda run -n ppt-master python ppt_to_md.py ./decks -o ./markdown
  conda run -n ppt-master python ppt_to_md.py deck.ppsx -o notes/deck.md
