...
Examples:
    conda run -n ppt-master python scripts/gemini_watermark_remover.py projects/demo/images/bg_01.png
    conda run -n ppt-master python scripts/gemini_watermark_remover.py image.jpg -o image_clean.jpg
